...
import { XCircle, CheckCircle, Clock, Calendar, FileText, AlertCircle, AlertTriangle, Filter, Building2, Users, Shield } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-red-100 mt-1">ผู้อำนวยการศูนย์เทคโนโลยีสารสนเทศฯ (Final)</p>
          </div>
          <div className="bg-white/20 backdrop-blur rounded-xl px-6 py-3 text-center">
            ...
            <div className="text-sm text-red-100">รออนุมัติ</div>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                selectedDepartment === 'all' ? 'bg-white/20' : 'bg-red-100 text-red-700'
              }`}>
            ...
            {Object.entries(departmentStats)
              ...
              .map(([dept, count]) => (
                ...
                >
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                    selectedDepartment === dept ? 'bg-white/20' : 'bg-red-100 text-red-700'
                  }`}>
                    {count}
                  </span>
                </button>
      ...
      {pendingCancels.length === 0 ? (
        ...
        <div className="grid gap-6">
          {filteredCancels.map((leave) => (
            <Card key={leave.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300 border-l-4 border-red-500">
              <div className="flex flex-col lg:flex-row">
                {/* Left Section - Employee Info */}
                <div className="p-6 lg:w-1/4 bg-gradient-to-br from-red-50 to-red-100/50">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-md">
                    ...
                    <div>
                      ...
                      <span className="inline-block mt-1 px-3 py-1 bg-red-500 text-white text-xs font-medium rounded-full">
                ...
                <div className="p-6 lg:w-72 bg-gray-50 flex flex-col justify-center gap-3">
                  {selectedCancel === leave.id ? (
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-semibold hover:from-red-600 hover:to-red-700 transition-all shadow-md"
                    >
