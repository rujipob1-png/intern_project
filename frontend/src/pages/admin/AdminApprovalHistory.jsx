...
import { CheckCircle, XCircle, Clock, Calendar, FileText, History, User, Filter, Building2, Users, Search, Eye, ArrowLeft } from 'lucide-react';
...
export default function AdminApprovalHistory() {
  ...
  const loadApprovalHistory = async () => {
    try {
      setLoading(true);
      const data = await adminAPI.getApprovalHistory();
  ...
  const departmentStats = approvalHistory.reduce((acc, leave) => {
    ...
    <div className="space-y-6 p-6 bg-slate-50 min-h-screen">
      ...
      {filteredHistory.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-slate-600">ไม่พบประวัติการอนุมัติ</h3>
            ...
            >
              <div className="p-6">
                <div className="flex flex-wrap gap-6">
                  ...
                  <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-slate-50 rounded-lg p-3">
                      ...
                      <div className="font-medium text-slate-800">
                        {formatDate(leave.approvedAt || leave.updatedAt)}
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  <span className="text-sm text-slate-500">เหตุผล: </span>
