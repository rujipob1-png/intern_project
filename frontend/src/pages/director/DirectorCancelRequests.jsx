...
import { XCircle, CheckCircle, Clock, Calendar, FileText, AlertCircle, User, AlertTriangle } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-orange-100 mt-1">ผู้อำนวยการกลุ่มงาน - รออนุมัติยกเลิก</p>
          </div>
